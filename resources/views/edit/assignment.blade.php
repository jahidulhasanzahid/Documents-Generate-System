		...
		<div class="container">
				...
				<input type="hidden" name="id" class="form-control" value="{{$document->id}}" readonly>
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" name="question" class="form-control" value="{{ $assignment->question }}">

				  </div>
				  <div class="form-group">
				    <label for="exampleInputEmail1">Answer</label>
				    <textarea class="form-control" name="answer" id="exampleFormControlTextarea1" rows="3">{{ $assignment->answer }}</textarea>
				  </div>
